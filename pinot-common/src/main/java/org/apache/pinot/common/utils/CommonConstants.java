...
public class CommonConstants {
  ...
  public static class Broker {
    ...
    public static final String CONFIG_OF_BROKER_EMIT_MAX_QPS_METRICS = "pinot.broker.emit.max.qps.metrics";
    public static final boolean DEFAULT_BROKER_EMIT_MAX_QPS_METRICS = false;
