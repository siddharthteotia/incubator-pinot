...
public final class NestedFieldSpec extends FieldSpec {

  private final Map<String, FieldSpec> _childFieldSpecs;

  // Default constructor required by JSON de-serializer. DO NOT REMOVE.
  public NestedFieldSpec() {
    super();
    _childFieldSpecs = new HashMap<>();
  }

  public NestedFieldSpec(@Nonnull String name, DataType dataType, boolean isSingleValueField) {
