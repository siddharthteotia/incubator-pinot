...
public class AggregationFunctionUtils {
  ...
  @Nonnull
  public static AggregationFunctionContext getAggregationFunctionContext(AggregationInfo aggregationInfo, BrokerRequest brokerRequest) {
  ...
  public static AggregationFunctionContext[] getAggregationFunctionContexts(
      BrokerRequest brokerRequest, @Nullable SegmentMetadata segmentMetadata) {
