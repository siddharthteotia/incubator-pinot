...
public class ObjectSerDeUtils {
  ...
  public enum ObjectType {
    ...
    public static ObjectType getObjectType(Object value) {
      ...
      } else if (value instanceof org.apache.pinot.core.query.aggregation.DistinctTable) {
  ...
  public static final ObjectSerDe<DistinctTable> DISTINCT_TABLE_SER_DE = new ObjectSerDe<DistinctTable>() {
    ...
    public byte[] serialize(DistinctTable tupleHolder) {
      try {
        ...
        throw new RuntimeException("Caught exception while serializing TupleHolder", e);
      }
    }
