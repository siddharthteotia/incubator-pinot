...
public class ApplyTransformNode implements PlanTreeNode{

  private String _name = "APPLY_TRANSFORM";
  private PlanTreeNode[] _childNodes; // can be scans or project
  private Set<String> _transformFunctions;

  public ApplyTransformNode(QueryContext queryContext, Set<String> transforms, boolean inFilter, TableConfig tableConfig) {
    ...
    if (!inFilter) {
      ...
      queryContext.getFilter().getColumns(colsInFilter);
